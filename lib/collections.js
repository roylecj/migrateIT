...
// Deactivate the items, instead of removing them...
  ...
  updateUser: function(userId, loginName, emailAddress, personName, perms) {

    Meteor.users.update(userId, {$set: {username: loginName, email: emailAddress, profile: {name: personName}}});

    Roles.setUserRoles(userId, perms);
  },
